...
function (ModuleView, Collection, Model, View) {
  describe("ModuleView", function () {
    ...
    it("renders a module with description and info", function () {
      ...
      moduleView.render();
      expect(getContent()).toEqual('<section class="testclass"><aside class="more-info" role="complimentary"><span class="more-info-link popover-link">more info</span><ul><li>Info line 1</li><li>Info line 2</li></ul></aside><h1>Title</h1><h2>Description</h2><div class="visualisation">test content</div></section>');
    });
    ...
    it("renders a module with description and info link", function () {
      ...
      moduleView.render();
      expect(getContent()).toEqual('<section class="testclass"><aside class="more-info" role="complimentary"><span class="more-info-link popover-link">more info</span><ul><li><a href="https://example.com/">Info line 1</a> with trailing text</li><li>Info line 2</li></ul></aside><h1>Title</h1><h2>Description</h2><div class="visualisation">test content</div></section>');
    });
