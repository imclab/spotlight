...
function (ModuleView, Collection, Model, View) {
  describe("ModuleView", function () {
    ...
    it("renders a module", function () {
      moduleView.render();
      expect(getContent()).toEqual('<section aria-labelledby="A-Title-heading" class="testclass"><h1 id="A-Title-heading">A Title</h1><div class="visualisation">test content</div></section>');
    });

    it("renders a module with description", function () {
      model.set('description', 'Description');
      moduleView.render();
      expect(getContent()).toEqual('<section aria-labelledby="A-Title-heading" class="testclass"><h1 id="A-Title-heading">A Title</h1><h2>Description</h2><div class="visualisation">test content</div></section>');
    });
    ...
    it("renders a module with description and info", function () {
      ...
      moduleView.render();
      expect(getContent()).toEqual('<section aria-labelledby="A-Title-heading" class="testclass"><aside class="more-info"><span class="more-info-link popover-link">more info</span><ul><li>Info line 1</li><li>Info line 2</li></ul></aside><h1 id="A-Title-heading">A Title</h1><h2>Description</h2><div class="visualisation">test content</div></section>');
    });
    ...
    it("renders a module with description and info link", function () {
      ...
      moduleView.render();
      expect(getContent()).toEqual('<section aria-labelledby="A-Title-heading" class="testclass"><aside class="more-info"><span class="more-info-link popover-link">more info</span><ul><li><a href="https://example.com/">Info line 1</a> with trailing text</li><li>Info line 2</li></ul></aside><h1 id="A-Title-heading">A Title</h1><h2>Description</h2><div class="visualisation">test content</div></section>');
    });
    ...
    it("renders an SVG-based module as a fallback element on the server", function () {
      jasmine.serverOnly(function () {
        ...
        expect(content).toEqual('<section aria-labelledby="A-Title-heading" class="testclass"><h1 id="A-Title-heading">A Title</h1><div class="visualisation-fallback" data-src="/test/url.png"><noscript><img src="/test/url.png"/></noscript></div></section>');
      });
    });
